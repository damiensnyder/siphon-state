...
var RoomsManager = /** @class */ (function () {
    ...
    RoomsManager.prototype.addTestGame = function (gameRoom) {
        this.activeGames[gameRoom.settings.gameCode] = gameRoom;
    };
    RoomsManager.prototype.generateGameCode = function () {
    ...
    RoomsManager.prototype.getActiveGames = function (req, res) {
        var foundGames = [];
    ...
    RoomsManager.prototype.sendToGame = function (req, res, nextHandler) {
